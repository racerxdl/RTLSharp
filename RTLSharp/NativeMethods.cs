...
namespace RTLSharp {
  ...
  public unsafe class NativeMethods {
    ...
    [DllImport(LibRtlSdr, CallingConvention = CallingConvention.Cdecl)]
    public static extern int rtlsdr_write_eeprom(IntPtr dev, byte *data, byte offset, UInt16 len);
    ...
    /// <returns>-3 if no EEPROM was found</returns>
    [DllImport(LibRtlSdr, CallingConvention = CallingConvention.Cdecl)]
    public static extern int rtlsdr_read_eeprom(IntPtr dev, byte *data, byte offset, UInt16 len);
    ...
    /// <returns>0 on success</returns>
    [DllImport(LibRtlSdr, CallingConvention = CallingConvention.Cdecl)]
    public static extern int rtlsdr_set_direct_sampling(IntPtr dev, int mode);
    ...
    /// <returns></returns>
    [DllImport(LibRtlSdr, CallingConvention = CallingConvention.Cdecl)]
    public static extern int rtlsdr_ir_query(IntPtr dev, byte *buf, int buf_len);
    #endregion
  }
}
